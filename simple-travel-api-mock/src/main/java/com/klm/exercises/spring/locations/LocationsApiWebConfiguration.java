...
import com.klm.exercises.spring.common.StatisticsFilter;
...
public class LocationsApiWebConfiguration implements WebMvcConfigurer {
    ...
    @Bean
    public FilterRegistrationBean<StatisticsFilter> loggingFilter(){
        FilterRegistrationBean<StatisticsFilter> registrationBean
          = new FilterRegistrationBean<>();

        registrationBean.setFilter(new StatisticsFilter());
